...
const intro_ico = require('../../../../assets/icons/learn/overall.png');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textBackground}>
        ...
        <Text style={[styles.title, {marginLeft: 30}]}>Overall Wellbeing</Text>
      </View>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('OverallSection')}>
